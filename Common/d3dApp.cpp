...
void D3DApp::OnResize()
{
	...
	//HR(mFactory->MakeWindowAssociation(mhMainWnd, DXGI_MWA_NO_WINDOW_CHANGES));
...
bool D3DApp::InitDirect3D()
{
	...
	/*while (true)
	{
		HRESULT tmp = dxgiFactory->EnumAdapters(i, &dxgiAdapter);
		if ( tmp != DXGI_ERROR_NOT_FOUND) break;
		else
		{
			pAdapter->CheckInterfaceSupport(tmp);
		}
	}*/
	sprintf(numString, "°¹¼ö: %d", i);
