  ...
  mTheta(1.3f*MathHelper::Pi), mPhi(0.4f*MathHelper::Pi), mRadius(2.5f)
{
	...
	XMStoreFloat4x4(&mTexTransform, I*4);
...
bool CrateApp::Init()
{
	...
	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/Rock.dds", &texResource, &mDiffuseMapSRV));
...
void CrateApp::OnResize()
{
	...
	XMMATRIX P = XMMatrixPerspectiveFovLH(0.1f*MathHelper::Pi, AspectRatio(), 1.0f, 1000.0f);
