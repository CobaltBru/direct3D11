...
{
	//Filter = ANISOTROPIC; // ºñµî¹æ

	Filter = MIN_MAG_MIP_LINEAR; // All linear
	//Filter = MIN_LINEAR_MAG_MIP_POINT; // Ãà¼Ò-¼± , È®´ë¹Ó¸Ê-Á¡
	//Filter = MIN_POINT_MAG_LINEAR_MIP_POINT; //Ãà¼Ò-Á¡,È®´ë-¼±,¹Ó¸Ê-Á¡
	MaxAnisotropy = 4;
